...
- (void)_invokeDelegateDidCompleteWithResults:(NSDictionary *)results
{
        ...
        UIAlertView *alr1   =   [[UIAlertView alloc] initWithTitle:@"Dyna-menu" message:@"ITEM SHARED SUCCESFULLY.YOU ARE LOGGED OUT FROM FACEBOOK.THANK YOU!" delegate:self cancelButtonTitle:@"OK"  otherButtonTitles: nil];
        [alr1  show];
